return {
  ...
  config = function()
    ...
    vim.env.FZF_DEFAULT_OPTS = '--bind ctrl-e:preview-down,ctrl-y:preview-up,ctrl-d:preview-page-down,ctrl-u:preview-page-up,tab:toggle-out,shift-tab:toggle-in'
