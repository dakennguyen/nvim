...
local statusline_bg = utils.get_hl("CursorLine").bg
vim.api.nvim_set_hl(0, "Statusline", { bg = statusline_bg })
vim.api.nvim_set_hl(
  0,
  "StatuslineNC",
  { fg = utils.get_hl("VertSplit").fg, bg = utils.get_hl("Normal").bg, underline = true }
)
vim.api.nvim_set_hl(0, "StatuslineGitAdded", { fg = utils.get_hl("GitSignsAdd").fg, bg = statusline_bg })
vim.api.nvim_set_hl(0, "StatuslineGitModified", { fg = utils.get_hl("GitSignsChange").fg, bg = statusline_bg })
vim.api.nvim_set_hl(0, "StatuslineGitDeleted", { fg = utils.get_hl("GitSignsDelete").fg, bg = statusline_bg })

vim.api.nvim_set_hl(
  0,
  "StatuslineModeVisual",
  { bold = true, fg = utils.get_hl("DiagnosticSignWarn").fg, bg = statusline_bg }
)
vim.api.nvim_set_hl(
  0,
  "StatuslineModeReplace",
  { bold = true, fg = utils.get_hl("DiagnosticSignError").fg, bg = statusline_bg }
)
vim.api.nvim_set_hl(0, "StatuslineModeNormal", { bold = true, fg = utils.get_hl("Normal").fg, bg = statusline_bg })
vim.api.nvim_set_hl(
  0,
  "StatuslineModeInsert",
  { bold = true, fg = utils.get_hl("DiagnosticSignInfo").fg, bg = statusline_bg }
)
vim.api.nvim_set_hl(
  0,
  "StatuslineModeTerminal",
  { bold = true, fg = utils.get_hl("DiagnosticSignHint").fg, bg = statusline_bg }
)
vim.api.nvim_set_hl(0, "StatuslineModeCommand", { bold = true, fg = utils.get_hl("Function").fg, bg = statusline_bg })
vim.api.nvim_set_hl(0, "StatuslineModeOther", { bold = true, fg = utils.get_hl("Number").fg, bg = statusline_bg })
vim.api.nvim_set_hl(0, "StatuslineItalic", { italic = true, bg = statusline_bg })
vim.api.nvim_set_hl(0, "StatuslineTitle", { bold = true, bg = statusline_bg })
vim.api.nvim_set_hl(0, "StatuslineInactive", { fg = utils.get_hl("Comment").fg, bg = statusline_bg })
...
local get_or_create_hl = function(hl)
  ...
  if not statusline_hls[hl] then
    ...
    vim.api.nvim_set_hl(0, hl_name, { bg = statusline_bg, fg = fg_hl })
