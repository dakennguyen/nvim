...
buf_map('n', '<space>gh', [[:nnoremap <lt>silent> <lt>space>gh :vert new <c-r><c-f><lt>cr><cr>]],             { noremap = false, silent = true })
buf_map('n', '<space>gr', [[:nnoremap <lt>silent> <lt>space>gr :tabnew <c-r><c-f><lt>cr><cr>]],               { noremap = false, silent = true })
