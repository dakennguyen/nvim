...
if !get(g:, 'tmux_navigator_no_mappings', 0)
  ...
  tnoremap <expr> <silent> <C-h> IsFZF() ? "\<C-h>" : "<C-\><C-n><C-w>h"
  tnoremap <expr> <silent> <C-j> IsFZF() ? "\<C-j>" : "<C-\><C-n><C-w>j"
  tnoremap <expr> <silent> <C-k> IsFZF() ? "\<C-k>" : "<C-\><C-n><C-w>k"
  tnoremap <expr> <silent> <C-l> IsFZF() ? "\<C-l>" : "<C-\><C-n><C-w>l"
