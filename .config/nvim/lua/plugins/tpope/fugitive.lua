return {
  ...
  keys = {
    ...
    { mode = "n", "<leader>gc", ":botright 0Gclog! --format='%H %s (%an)' | copen<CR>", silent = true, desc = "Git log current file" },
    { mode = "v", "<leader>gc", ":Gclog! --format='%H %s (%an)' | copen | wincmd J<CR>", silent = true, desc = "Git log range" },
